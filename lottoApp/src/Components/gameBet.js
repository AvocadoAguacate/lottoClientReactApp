...
class gameBet extends Component {
      ...
      <View>
        {this.state.beting ? (
          <View style={styles.container}>
            ...
            <Text
              style={styles.text}
            >{`Multiplicador: ${this.props.multiplier}`}</Text>
            <Text
              style={styles.text}
            >{`Apuesta maxima: ${this.props.maxAmountBet}`}</Text>
            <Text
              style={styles.text}
            ...
            />
            <TouchableHighlight style={styles.button} onPress={this.bet}>
  ...
  bet = async () => {
    if (
      ...
      await fetch(global.url + "play", {
        ...
        .then(responseData => {
          if (responseData.registered) {
            ToastAndroid.show(
              `Hemos recibido su apuesta, suerte`,
              ToastAndroid.SHORT
            );
            ...
            ToastAndroid.show(
              `Algo salio mal, intenta más tarde, nunca te rindas`,
              ToastAndroid.SHORT
            );
          }
        })
      ...
      ToastAndroid.show(
        `Revisa tu apuesta, no mayor a ${this.props.maxAmountBet} y tu número de la suerte`,
        ToastAndroid.SHORT
      );
    }
  };
